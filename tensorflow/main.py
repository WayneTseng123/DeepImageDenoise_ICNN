...
parser.add_argument('--eval_set', dest='eval_set', default='BSD200', help='dataset for eval in training')
parser.add_argument('--test_set', dest='test_set', default='BSD100', help='dataset for testing')
